...
def home(request):
    ...
    context["hero_cards"] = [
        {"title": "Massage thư giãn", "shape": "arch", "theme": "theme-warm"},
        {"title": "Sauna trị liệu", "shape": "circle", "theme": "theme-gold"},
        {"title": "Chăm sóc cổ vai gáy", "shape": "tall", "theme": "theme-cocoa"},
    ]
...
def service_detail(request):
    ...
    context["service"] = SERVICE_LIST[0]
    context["gallery"] = [
        "theme-blush",
        "theme-cocoa",
        "theme-apricot",
...
def reviews(request):
    ...
    context["review_items"] = [
        {"id": 1, "title": "Thanh lọc da", "status": "Đã đánh giá", "status_class": "status-green", "theme": "theme-ivory"},
        {"id": 2, "title": "Massage cổ vai gáy", "status": "Đã đánh giá", "status_class": "status-green", "theme": "theme-pearl"},
        {"id": 3, "title": "Dưỡng da chuyên sâu", "status": "Chưa đánh giá", "status_class": "status-red", "theme": "theme-blush"},
        {"id": 4, "title": "Massage body đá nóng", "status": "Chưa đánh giá", "status_class": "status-red", "theme": "theme-cocoa"},
        {"id": 5, "title": "Chăm sóc gương mặt", "status": "Đã đánh giá", "status_class": "status-green", "theme": "theme-apricot"},
        {"id": 6, "title": "Gội đầu dưỡng sinh", "status": "Chưa đánh giá", "status_class": "status-red", "theme": "theme-cocoa"},
    ]
...
def review_write(request):
    context = base_context("/reviews/")
    context["success"] = request.GET.get("success") == "1"
